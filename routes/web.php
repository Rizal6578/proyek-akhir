...
Route::middleware(['preventBackHistory'])->group(function () {
    ...
    Route::get('/admin/register', [RegisterController::class, 'index'])->middleware('useractive');
    Route::post('/admin/proseslogin', [LoginController::class, 'proseslogin'])->middleware('useractive');
    Route::post('/admin/prosesregister', [RegisterController::class, 'prosesregister'])->middleware('useractive');
